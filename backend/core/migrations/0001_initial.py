...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Channel',
            fields=[
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='creator_profile', serialize=False, to=settings.AUTH_USER_MODEL)),
                ...
                ('x', models.URLField(blank=True, max_length=255, null=True, verbose_name='Twitter/X')),
